...
const AddTaskModal = ({ isOpen, onClose }) => {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        dispatch(addTask({ title, description, deadline, priorityLevel }));
    ...
    return (
        <Modal isOpen={isOpen} onClose={onClose}>
            ...
            <form className='flex flex-col gap-4' onSubmit={handleSubmit}>
                ...
                <div className='flex flex-col'>
                    <label htmlFor="description" className='text-sm font-semibold'>Priority Level of Task</label>
                    <input
                        type="text"
                        id="priorityLevel"
                        placeholder='Enter Priority Lavel'
                        value={priorityLevel}
